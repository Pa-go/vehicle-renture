...
<div id="mainContent" class="main-content">
    ...
    <section class="video-banner">
        <div class="video-card">
            <video id="topVideo" src="video/Hailuo Video create a 3d video that has a c 446137454554259461.mp4" autoplay muted loop playsinline preload="metadata"></video>
        ...
        <div class="listings-container" id="listingsContainer">
            <div class="card">
                ...
                <div class="card-details">
                    ...
                    <a href="booking-preview.php? name=Toyota Camry Hybrid&price=40000&brand=Toyota&model=Camry&type=Car" class="pay-now-link">
            ...
            <div class="card">
                ...
                <div class="card-details">
                    ...
                    <button class="view-details-btn">View Details</button>
                    <a href="booking-preview.php? name=Honda Civic&price=25000&brand=Honda&model=Civic&type=Car" class="pay-now-link">
                        <button class="view-details-btn" style="background: linear-gradient(135deg, #001F3F, #193857); color: white; margin-top: 8px; width: 100%;">Book Now</button>
                    </a>
                </div>
            </div>
            <div class="card">
                ...
                <div class="card-details">
                    ...
                    <button class="view-details-btn">View Details</button>
                    <a href="booking-preview.php? name=Tesla Model 3&price=55000&brand=Tesla&model=Model 3&type=Car" class="pay-now-link">
                        <button class="view-details-btn" style="background: linear-gradient(135deg, #001F3F, #193857); color: white; margin-top: 8px; width: 100%;">Book Now</button>
                    </a>
                </div>
            </div>
            <div class="card">
                ...
                <div class="card-details">
                    ...
                    <button class="view-details-btn">View Details</button>
                    <a href="booking-preview.php? name=Ford F-150&price=35000&brand=Ford&model=F-150&type=Truck" class="pay-now-link">
                        <button class="view-details-btn" style="background: linear-gradient(135deg, #001F3F, #193857); color: white; margin-top: 8px; width: 100%;">Book Now</button>
                    </a>
                </div>
            </div>
            ...
            <a href="form2.php" class="add-vehicle-link">
